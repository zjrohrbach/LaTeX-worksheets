...
\title{Newton \#4 (Weight \& Vertical Motion)}
\author{Rohrbach}
\date{\today}
...
\question \emph{Horizontal Review Problem:} A 1250-kg car is propelled by an applied force 4500~N. The force of friction is 212~N and there is 490~N of drag.  Calculate the car's acceleration.
\vs[2]
...
\question
  What is the normal force acting on a 65-kg man standing in an elevator that is accelerating downward at a rate of \SI{3.1}{m/s^2}?
  \vs[3]
