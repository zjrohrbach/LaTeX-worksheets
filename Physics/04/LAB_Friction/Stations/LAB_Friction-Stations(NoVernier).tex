...
\begin{enumerate}
  ...
  \item
    Explain what Figure~4.3 is attempting to show.

    \includegraphics[height=2.5cm]{04_03_Figure.jpg}
...
\pagebreak
  ...
  \item
    Use your answer from question~\ref{static-sliding} to explain why antilock braking systems in cars prevent sliding on the ice.
    \vs
...
\begin{enumerate}
  \item 
    Hook up the \textbf{10-N spring scale} to one of the blocks. Place 800 grams on top of the block.  Pull the block until it moves.  Pay particular attention to what happens to the reading on the scale just before it ``budges.''  Using what you learned in Section~\ref{book}, explain how this shows the difference between static friction and sliding (kinetic) friction.
    \vs

  \item Write down the maximum value of the static friction that the scale reads just before the block ``budges'' and starts to move.
  ...
  \item 
    Let's test your prediction.  Remove all of the weight from the block and place just one single 200-g weight on the block.  Measure \emph{sliding (kinetic) friction}.  Repeat with 400~g and 600~g.
  ...
  \item \label{material-predict}
    What do you think will happen if you turn the block upside down so that the rubber side is facing down?  Will you have more or less friction?
    \vs 
 ...
 \item \label{area-predict}
  ...
  \item 
    Let's test your prediction.  You can copy your data for the first line from question~\ref{measure-sliding}.  Then, turn the block on its side, make sure to stack the 800 grams on top, and measure the kinetic friction.
