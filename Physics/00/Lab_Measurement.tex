...
\begin{enumerate}[topsep=0pt,itemsep=-1ex,partopsep=1ex,parsep=1ex]
  \item Drop the ball
  \item Stand back and watch how high the ball bounces.  Convert to meters.
...
\newcommand{\datatable}{
  \begin{center}
    \begin{tabular}
      ...
      \hline
      \multirow{2}{\cw}
        {\centering Drop Height (m)} & 
      \multicolumn{4}{c|}{Bounce Height (m)} \\
      \cline{2-5}
...
\begin{questions}
  ...
  \question
  What is the physical meaning of the slope of these best fit lines?
  \vs

  \question
  The expected values for the ``bounciness'' of the balls are as follows: \\
  Golf ball: 0.7; \hspace{3em} 
