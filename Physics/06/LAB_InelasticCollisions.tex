...
\question \label{time}
\emph{Before you get started:} Measure the height of the table (make sure to convert it into meters).  Use the equation $d=v_i t+\frac{1}{2}at^2$ to calculate how much time it would take a marble launched horizontally to fall from the tabletop to the ground. Remember, because the ball leaves the table horizontally, the $v_i=0$ in the $y$-direction.  Your answer should be less than 1~second. 

\vspace{1em}

\underline{$y$-direction}
...
Calculate how far the marble should travel out before reaching the ground if it takes the amount of time calculated in \#\ref{time} to reach the ground and it is moving at the speed measured in \#\ref{vi}. (\emph{Hint:} use $v = d/t$).
\vs
...
Now use $v = d/t$ to calculate how far out from the table the marble should land. Remember, the time to fall is the same that your calculated in \#\ref{time}.
\vs
