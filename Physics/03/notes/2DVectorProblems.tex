  ...
  \paragraph{Ex \#3} 
    ...
    \begin{tikzpicture}[scale=1.5]
      \begin{scope}[thick, orange]
        ...
        \draw[vector] (ball) -- (53:2.5)
          node[midway, above, rotate=58] {12.5 m/s};
      \end{scope}
    \end{tikzpicture}
  }
...
\newcommand{\probfour}{
  \paragraph{Ex \#4} 
    ...
    \begin{tikzpicture}
      \begin{scope}[scale=2]
        \node at (0,0) 
          {\includegraphics[angle=-15,origin=c,width=3cm]{airplane.png}};
        ...
        \draw (-1,-1.1) -- ++(5.5,0);
        \draw[->] (a) ++(.7,0) arc (0:-15:.7);
        \node at (1.5,-.3) {$15^\circ$};
      \end{scope}
    \end{tikzpicture}
}
