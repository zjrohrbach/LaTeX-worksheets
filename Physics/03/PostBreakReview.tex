...
\begin{questions}
  ...
  \begin{tikzpicture}[
    ...
    \draw (9,6) -- ++(5,0);
    \draw (11.5,6.5) -- ++(0,-4);
    \node at (10.25,6.25) {$x$-direction};
    \node at (12.75,6.25) {$y$-direction};
  ...
  \end{tikzpicture}
    ...
    \begin{parts}
      \part Calculate the \textbf{resultant initial velocity} and the \textbf{launch angle} of the projectile.  And then label them in the diagram above. \vs
      \part Calculate the \textbf{time} that the projectile was in the air. \vs
      \part Calculate the total \textbf{$x$-displacement} of the projectile. \vs
    \end{parts}
