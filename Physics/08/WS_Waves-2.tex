...
\question
  Draw a wave with an amplitude of 1.5~m and a wavelength of 6~m.
    ...
    \uplevel{\emph{The following problems are review of pendulum and spring math...}}


    % NOTE: THESE PROBLEMS RIPPED FROM SH #3 (2026/04/14)

    \question  Find the length of a pendulum that oscillates 5 times in 6.5~seconds. \vs 
    ...
    \begin{parts}
      ...
      \part Calculate the frequency of the spring. \vspace{4em}
    \end{parts}
