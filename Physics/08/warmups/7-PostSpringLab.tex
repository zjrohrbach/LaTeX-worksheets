...
\def\todayDate{Wed, Mar 11 (Pd 6) / Thu, Mar 12 (Pd 1, 4)}
...
\question
  When an oscillating spring reaches the equilibrium position, the net restoring force is zero.  Why, then, does the spring continue to move past equilibrium and continue its oscillation?
  \vs
\end{questions}
}
