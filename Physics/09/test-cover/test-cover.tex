...
\newcommand{\drawscantron}[2]{
  \begin{flushright}
    \begin{tikzpicture}
      \node[anchor=south west] at (0,0) {\includegraphics[width=.7\textwidth]{12Q.png}};
      \fill (#1,#2) circle (0.25);
      \node[anchor=west] at (1.8,12.25) {\footnotesize \mytitle};
      \fill[white] (7.2,9) rectangle (8.25,1.5);
  ...
  \drawscantron{4.9}{1.95}
  \topmatter

\pagebreak

  \drawscantron{5.45}{1.95}
  \topmatter
