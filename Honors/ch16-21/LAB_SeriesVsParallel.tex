...
\begin{questions}
  \question
    ...
    \begin{tikzpicture}
      \node at (-4, 3) {\includegraphics{circuit1.png}};
      \node at ( 4, 3) {\includegraphics{circuit2.png}};
      \node at (-4,-3) {\includegraphics{circuit3.png}};
      \node at ( 4,-3) {\includegraphics{circuit4.png}};
      \draw (-7,0) -- (7,0);
      \draw (0,-5) -- (0,5);
    \end{tikzpicture}
