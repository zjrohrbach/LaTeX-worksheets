...
\question
A single electron is placed \SI{3.0}{nm} to the right of a \SI{+0.4}{nC} charge.  Calculate the \emph{magnitude} and \emph{direction} of the force acting on the electron.
