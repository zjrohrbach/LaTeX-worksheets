...
\question
  ...
  \begin{tikzpicture}
    ...
    \draw (0,2)
      to[R={$R_1=\SI{2}{\ohm}$}]  ++(3,0) coordinate (1)
      to ++(2,0) coordinate (2)
      to[R={$R_2=\SI{1}{\ohm}$}]  ++(3,0) 
      to[R={$R_3=\SI{2}{\ohm}$}]  ++(0,-2) coordinate (3)
      to ++(-5,0) coordinate (4)
      to[R={$R_5=\SI{3}{\ohm}$}]  (0,0)
      ;
    \draw (1) to[R={$R_4=\SI{6}{\ohm}$}] (4);
    \draw (0,2) to[battery,l_=\SI{70}{V}] (0,0);
  \end{tikzpicture}


  \begin{parts}
    \part Calculate Equivalent Resistance
    \part Calculate the current through \emph{each} resistor.
  ...
  \end{parts}
    ...
    \begin{flushright}
      \begin{tabular}{ccccccc}
        && Current $I$ (Amperes) &&& Potential Difference $\Delta V$ (Volts) &\\
        \hline\hline
        Battery \\\hline
        $R_1= \SI{2}{\ohm}$ \\\hline
        $R_2= \SI{1}{\ohm}$ \\\hline
...
%       \hline\hline
%       Battery \\\hline
%       $R_1= \SI{1}{k\ohm}$ \\\hline
%       $R_2= \SI{2}{k\ohm}$ \\\hline
%       $R_3= \SI{1}{k\ohm}$ \\\hline
%       $R_4= \SI{2}{k\ohm}$ \\\hline
%       $R_5= \SI{1}{k\ohm}$ \\\hline
%       $R_6= \SI{1}{k\ohm}$ \\\hline\hline
%     \end{tabular}
%   \end{parts}
