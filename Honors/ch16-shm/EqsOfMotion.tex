...
\question 
  ...
  %
  \begin{align*}
    y(t)=0.50\cos\left(12.47 \cdot t\right) \, ,
  \end{align*}
  %
  ...
  \begin{parts}
    ...
    \part 
      Calculate the spring constant $k$ of this spring.
      \vs

    \part 
      At $t=1.6$~s, what will be the \emph{location} of the mass and what will be its \emph{velocity}?
      \vs

    \part At $t=1.6$~s, what is the KE and PE of the system?
      \vs
...
\question
  Now, try plotting $y=A\sin(2\pi f \cdot t + \phi)$ on Desmos. Use the ``slider'' capability of Desmos to investigate how changing $f$ and $A$ changes the graph.
