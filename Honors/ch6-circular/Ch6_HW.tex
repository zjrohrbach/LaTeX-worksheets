...
% \def\enoteheading{Answers}
% \def\answer#1{\endnotetext{#1}}
% \def\theanswers{\theendnotes}
% \def\myquestion{\question\stepcounter{endnote}}

\def\mytitle{Chapter 6 Homework}
\title{\mytitle}
\author{Rohrbach}
\date{\today}
...
\section*{Homework Check A (collected on Fri, Nov 14)}
...
\begin{checkboxes}
  \choice 6.1 Rotation Angle \& Angular Velocity \dotfill Wed, Nov 5
  \choice 6.2 Centripetal Acceleration \dotfill Wed, Nov 5
  \choice 6.3 Centripetal Force \dotfill Wed, Nov 5
  \choice 6.4 Fictitious Forces\dotfill Tue, Nov 11
\end{checkboxes}
...
\section*{Homework Check B (collected on Test Day - Wed-Thu, Nov 19-20)}
...
\begin{checkboxes}
  \choice 6.5 Newton's Law of Universal Gravitation \dotfill Wed, Nov 12
  \choice 6.6 Satellites \& Kepler's Laws \dotfill Fri, Nov 14
\end{checkboxes}
...
\begin{tabular}{|*{3}{p{4.5cm}|}}
  \hline
  %
  \bs{Friction}{5} & \bs{Univ. Grav.}{5} & \bs{Satellites}{5}\\  
                   &                               & \\[1.9cm]\hline
\end{tabular}
...
\begin{tabular}{|*{4}{p{3.3cm}|}}
  \hline
  %
  P\#\ref{b1}  &  P\#\ref{b2}  &  P\#\ref{b3}  &  P\#\ref{b4} \\[1.5cm]
  %
  \hline
\end{tabular}
...
\twocolumn
Questions and figures are from OpenStax \emph{College Physics},2nd ed, (Chapter 6) or Giancolli \emph{Physics: Principles with Applications}, 7th ed, (Chapter 5) unless otherwise noted.
...
\answer{(a) \SI{86400}{sec}; (b) \SI{7.3e-5}{rad/s}; (c) 467 m/s}
...
\begin{enumerate}[label=CQ\arabic*.]
  ...
  \begin{figure}[h]
    ...
    \caption{Giancoli Fig 5-35.  Please note that this is a top-down view of a \emph{horizontal} surface}
    \label{G5-35}
  \end{figure}
\end{enumerate}
...
\myquestion (Giancolli P18)
Tarzan plans to cross a gorge by swinging in an arc from a hanging vine (Figure~\ref{G5-42}).  If his arms are capable of exerting a force of 1150~N on the vine, what is the maximum speed he can tolerate at the lowest point of his swing?  His mass is 78~kg and the vine is 4.7~m long. \answer{4.82~m/s}

  \begin{figure}[h]
    \centering
    \includegraphics[height=5.2cm]{05_42_Figure.jpg}
    \caption{Giancolli Fig. 5-42}
    \label{G5-42}
  \end{figure}


\myquestion (Giancolli P7)
A car travels at constant speed down the bottom of a valley and up the other side of a road whose bottom has a radius of curvature of 115~m.  The driver feels a normal force equal to twice their weight. What is the car's speed?
\answer{33.6 m/s}
...
\answer{9.1 m/s}
  ...
  % \begin{figure}[h]
  %   \centering
  %   \includegraphics[width=3.3cm]{05_48_Figure.jpg}
  ...
  % \begin{figure}[h]
  %   \centering
  %   \includegraphics[width=6cm]{6-35.jpg}
...
\myquestion \label{b1} \textbf{Bonus!} (Giancolli P71, modified) In a ``Roto-ride'' at a carnival (Figure~\ref{G5-47}), people are rotated in a cylindrically walled ``room.''  The room has a radius of 4.6~m, and the wall spins at a speed of 14.5~m/s when the floor drops out.  What is the minimum coefficient of static friction so that a 40-kg person will not slip down?  Make sure to draw a free-body diagram

    \begin{figure}[h]
      \centering
      \includegraphics[width=4cm]{05_47_Figure.jpg}
      \caption{Giancolli Fig.~5-47}
      \label{G5-47}
    \end{figure}

% \myquestion \label{b1} \textbf{Bonus!} (OpenStax P31) 
...
\begin{enumerate}[resume*]
  ...
  \item (Giancolli CQ5) A child on a sled comes flying over the crest of a small hill, as shown in Figure~\ref{G5-32}. His sled does not leave the ground, but he feels the normal force between his chest and the sled decrease as he goes over the hill. Explain this decrease using Newton's second law.
    ...
    \begin{figure}[h]
      \centering
      \includegraphics[width=4.5cm]{05_32_Figure.jpg}
  ...
  \item (Giancolli CQ10) A car maintains a constant speed $v$ as it traverses the hill and valley shown in Figure~\ref{G5-34}. Both the hill and valley have a radius of curvature $R$. (a) At which point (A, B, or C) is the normal force acting on the car the largest? (b) At which point is it the smallest? Explain. (c) Where would the driver feel heaviest? (d) Where would the driver feel lightest? Explain. (e) How fast (in terms of $g$ and $R$) can the car go without losing contact with the road at A?
    ...
    \begin{figure}[h]
      \centering
      \includegraphics[width=8cm]{05_34_Figure.jpg}
  ...
  \item (Based on OpenStax CQ15 and Giancolli MC6) In one amusement park ride--called the ``Roto-Ride''-- riders enter a large vertical barrel and stand against the wall on its horizontal floor. The barrel is spun up and the floor drops away. Riders feel as if they are pinned to the rotating wall.  Which free-body diagram from Figure~\ref{G5-36} correctly identifies the forces acting on the rider?
    \begin{figure}[h]
      \centering
      \includegraphics[width=7.8cm]{05_36_Figure.jpg}
...
\begin{enumerate}[resume*]
  \item (OpenStax CQ6) Race car drivers routinely cut corners as shown in path \#2 in Figure~\ref{6.29}. Explain how this allows the curve to be taken at the greatest speed.
    \begin{figure}[ht]
      \centering
...
\myquestion \label{b2} \textbf{Bonus!} (OpenStax P25)
...
\myquestion \label{b3} \textbf{Bonus!} (OpenStax P26)
...
\myquestion \label{b4} \textbf{Bonus!} (OpenStax P30) \hfill
...
\begin{enumerate}[resume*]
  \item (Giancolli MC8) \hfill Which pulls harder gravitationally, the Earth on the Moon, or the Moon on the Earth? Which accelerates more?
