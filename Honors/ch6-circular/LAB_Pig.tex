...
\question
  Calculate the \emph{linear speed} of your flying pig. 
  \vs

\question
  Calculate the \emph{angular speed} in rpm.
  \vs


\question
  The pig's mass is approximately 0.4~kg.  Calculate the \emph{centripetal force}.
  \vs

\question
  \emph{Challenge:} The centripetal force you calculated is the $x$-component of the tension.  See if you can calculate the total tension using the free-body diagram you drew in question~\ref{fbd}.
  \vs
