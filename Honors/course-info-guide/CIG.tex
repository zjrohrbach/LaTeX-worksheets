...
\section*{Class Policies}
	...
	\paragraph{Cell Phones and Earbuds}
		In Honors Physics, there is no instructional need for cell phones or earbuds.  They should therefore be put away at all times.  Failure to comply will result in the progressive discipline outlined in the AHS Student Handbook on p. 25.
...
\begin{tikzpicture}
	...
	\node at (3,1.7) {\includegraphics[width=2.4cm]{laptop}};

	
	\node [font=\large] at (6, .5) {Computer};
	\node [font=\large] at (6, 0)  {Charger};
	\node at (6,1.7) {\includegraphics[width=2.4cm]{charger}};

	\node [font=\large] at (9, .5) {Reading};
	\node [font=\large] at (9, 0)  {Book};
	\node at (9,1.7) {\includegraphics[width=2.4cm]{book}};
