...
\def\mytitle{Chapter 2 (Kinematics) Homework B}
\title{\mytitle}
\date{\today}
...
\noindent
%
\includegraphics[height=2.5in]{strobe.jpeg}
%
\hfill
%
\includegraphics[height=2.5in]{cars.jpg}
...
\myquestion (P31) \answer{(a) \SI{51.4}{m}; (b) \SI{17.1}{s}} 
