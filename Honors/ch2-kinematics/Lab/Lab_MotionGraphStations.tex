...
\begin{enumerate}
  ...
  \item During which interval of time in the motion was the acceleration constant?  How can you tell? \vs 
  \item Was there any point in the motion where the velocity was zero? Explain. \vs
  \item What is interesting about the \emph{velocity graph} at the point in time when the cart is at its largest position? \vs
...
\begin{enumerate}
  ...
  \item Was there any point in the motion where the velocity was zero? Explain. \vs 
  \item Look carefully at your graphs.  When the position graph is at a maximum or minimum, what is true about the velocity graph?  Why does this make sense? \vs
...
\emph{\small Credit to Dr.\ Dennis Krause, Wabash College, for the inspiration behind Station \#3.}
...
\begin{enumerate}
  ...
  \item Were there any points in the motion where the velocity was zero? Explain. \vs 
  
  \item Was there any intervals of time in the motion where the acceleration was constant? Explain. \vs 
...
\vspace{-1em}
\begin{center}
  \includegraphics[height=1.1in]{walking.png} 
\end{center}
...
\begin{enumerate}
  ...
  \item Find the position on the ground marked ``0 meters'' and stand there.  Have a lab partner click the ``Position'' meter at the bottom right corner of the screen, ``Reverse'' the sensor, and click ``Zero.''

  \hfill \includegraphics[height=1.2in]{zero}
...
\subsection*{Position Graph Matching}\begin{enumerate}[resume]
...
\subsection*{Velocity Graph Matching}\begin{enumerate}[resume]
...
\begin{enumerate}
  \item Explain the significance of the slope of a position graph. Include a discussion of positive and negative slope. \vs 
  \item What type of motion is occurring when the slope of a position graph is zero? \vs
  \item What type of motion is occurring when the slope of a position graph is constant? \vs
  \item What type of motion is occurring when the slope of a \emph{velocity} graph is zero? \vs
\end{enumerate}
