...
\begin{multicols}{2}
  ...
  \begin{enumerate}[label=\alph*),topsep=0pt,itemsep=-1ex,partopsep=1ex,parsep=1ex]
    ...
    \item \label{origin}\textbf{Important!} Make sure that your graph includes (0,0). You can go to ``Edit Graph options'' in the Graph Tools, \includegraphics[height=1.2em]{graph-tools}, menu to change your domain and range.
