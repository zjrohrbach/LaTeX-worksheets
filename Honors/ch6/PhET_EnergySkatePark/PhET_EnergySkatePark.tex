...
\question
  ...
  \begin{minipage}{5in}
    \begin{parts}
      \part
        Change the track to the, ``W,'' shaped track (see image to the right).  Put your skater on the track and let them go.  How did (or didn't) her total energy change? 
      \part
        Increase or decrease the mass of your skater.  What changes (or doesn't change) about her total energy?  
    \end{parts}
    \vspace*{3em}
  \end{minipage}
  %
...
\question
  ...
  \begin{parts}
    ...
    \part
      Is friction a conservative force?  Explain using evidence from the simulation.
      \vs
