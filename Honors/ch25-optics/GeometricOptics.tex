...
\begin{itemize}
  \item occurs when the angle is \fillin[too large][9em] for refraction to occur and the light \fillin[reflects][10em] instead.
  \item occurs when the angle of incidence is larger than the \fillin[critical angle][12em].
\end{itemize}
...
\begin{questions}
  ...
  \question
    If you shine a laser beam at an angle of $12^\circ$ to the normal into a block of ice, what is the angle of refraction?
    \vs
...
\begin{enumerate}
  \item A ray traveling parallel to the principal axis gets reflected to \fillin[the focal point][10em]
...
\begin{enumerate}
  \item A ray traveling parallel to the principal axis gets refracted to \fillin[the focal point][10em]
