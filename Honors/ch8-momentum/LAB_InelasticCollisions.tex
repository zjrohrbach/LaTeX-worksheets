...
\question \label{time}
\emph{Before you get started:} Measure the height of the table (make sure to convert it into meters).  Calculate how much time it would take a marble launched horizontally to fall from the tabletop to the ground.
...
Calculate how far the marble should travel out before reaching the ground if it takes the amount of time calculated in \#\ref{time} to reach the ground and it is moving at the speed measured in \#\ref{vi}.
\vs
...
Now, calculate how far out from the table the marble should land. Remember, the time to fall is the same that your calculated in \#\ref{time}.
\vs
